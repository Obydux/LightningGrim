...
public class EquipmentSlot extends Slot {
    ...
    public boolean mayPickup(GrimPlayer player) {
        ...
        return (itemstack.isEmpty() || player.gamemode == GameMode.CREATIVE || itemstack.getEnchantmentLevel(PacketEnchantmentTypes.BINDING_CURSE, ServerVersions.getServerVersion().toClientVersion().getProtocolVersion()) == 0) && super.mayPickup(player);
    }
}
