...
//        }
    ...
    private static Function<Component, Text> nativeTextMapperFunction = (component) -> null; //Text.Serialization.fromJsonTree(GsonComponentSerializer.gson().serializeToTree(component), DynamicRegistryManager.EMPTY);
